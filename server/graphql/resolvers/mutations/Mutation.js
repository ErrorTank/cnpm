...
const {register, resendConfirmEmail, registerSocial, confirmForgotPassword, changePassword, addRecentVisit, addToFavorites, addToCart, removeFromCart} = require("../../../db/model/user/controller");
